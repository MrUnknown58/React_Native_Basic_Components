...
const ActionCards = () => {
  const onPress = (website: string) => {
    Linking.openURL(website);
  };
  return (
    <View classname="flex justify-center items-center">
      <Text className="text-2xl text-pink-400">Action Cards</Text>
      <ScrollView
        ...
        <View className="p-4 w-[300px]">
          <View className="bg-white border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
            ...
            <View className="p-6">
              ...
              <TouchableOpacity
                onPress={() => {
                  onPress('https://reactnative.dev/docs/touchableopacity');
                }}>
                <Text className="text-black">Know More</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
          ...
          <View className="p-4 w-[300px]">
            <View className="border-2 bg-white border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
              ...
              <View className="p-6">
                ...
                <Text className="tracking-widest text-xs title-font font-medium truncate text-gray-400">
                  "Jujutsu Kaisen" is a popular Japanese manga series written
                  and illustrated by Gege Akutami. It falls under the genres of
                  dark fantasy, supernatural, and action.
                </Text>
              </View>
            </View>
          </View>
